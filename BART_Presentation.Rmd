...
This is one of the major weaknesses of BART; another is that BART has a longer execution time than comparable methods (random forests, neural networks, gradient boosting) for the same values of $n$. 
...
- Your data has a clear linear, quadratic fit, or depends on a known function
