...
Figure Out Sumn to do here later
...
classX = model.matrix(~ baseline.value + accelerations + fetal_movement + uterine_contractions + 
                        light_decelerations + severe_decelerations + prolongued_decelerations + 
                        abnormal_short_term_variability - 1, data = fetalCSV)
