...
- Add example of a very simple regression tree and graph associated step function
...
## Other Sum-Of-Trees Models

- Create based on whatever other tree stuff we do in class
